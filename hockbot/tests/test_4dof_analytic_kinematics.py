...
class Test4DoFKinematics(unittest.TestCase):
    ...
    def test_fkin(self):
        ...
        res = fkin(theta0, theta1, theta2, theta3, 0)
        assert np.allclose(res, [-2.4492935982947072e-17, -0.40000000000000013, 9.265260047530536e-17, -4.71238898038469, 0])

    def test_ikin(self):
        b = ikin(0, -0.4, 0, surface=SURFACE_COLLECT)
        print(b)
